...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public List<Vector3> m_PreviousFrameMeshVertices = new List<Vector3>();
        public List<Vector3> m_MeshVertices = new List<Vector3>();
        public Vector3 m_PlaneCenter = new Vector3();

        public List<Color> m_MeshColors = new List<Color>();

        public List<int> m_MeshIndices = new List<int>();
